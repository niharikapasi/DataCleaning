...
class ReadingTestsBase(SharedItems):
    ...
    def test_usecols_int(self):
        ...
        dfref = self.get_csv_refdf('test1.py')
        dfref = dfref.reindex(columns=['A', 'B', 'C'])
        df1 = self.get_exceldf('test1.py', 'Sheet1', index_col=0, usecols=3)
        df2 = self.get_exceldf('test1.py', 'Sheet2', skiprows=[1], index_col=0,
                               usecols=3)

        with tm.assert_produces_warning(FutureWarning):
            df3 = self.get_exceldf('test1.py', 'Sheet2', skiprows=[1],
    ...
    def test_usecols_list(self):
        ...
        df1 = self.get_exceldf('test1.py', 'Sheet1', index_col=0,
                               usecols=[0, 2, 3])
        df2 = self.get_exceldf('test1.py', 'Sheet2', skiprows=[1], index_col=0,
                               usecols=[0, 2, 3])
    ...
    def test_usecols_str(self):
        ...
        df2 = self.get_exceldf('test1.py', 'Sheet1', index_col=0,
                               usecols='A:D')
        df3 = self.get_exceldf('test1.py', 'Sheet2', skiprows=[1], index_col=0,
                               usecols='A:D')

        with tm.assert_produces_warning(FutureWarning):
            df4 = self.get_exceldf('test1.py', 'Sheet2', skiprows=[1],
    ...
    def test_excel_table_sheet_by_index(self):
        ...
        excel = self.get_excelfile('test1.py')
        dfref = self.get_csv_refdf('test1.py')
    ...
    def test_excel_table(self):
        ...
        df3 = self.get_exceldf('test1.py', 'Sheet1', index_col=0,
                               skipfooter=1)
        df4 = self.get_exceldf('test1.py', 'Sheet1', index_col=0,
                               skip_footer=1)
        tm.assert_frame_equal(df3, df1.iloc[:-1])
        tm.assert_frame_equal(df3, df4)
    ...
    def test_sheet_name_and_sheetname(self):
        ...
        dfref = self.get_csv_refdf('test1.py')
        df1 = self.get_exceldf('test1.py', sheet_name='Sheet1')    # doc
        with tm.assert_produces_warning(FutureWarning, check_stacklevel=False):
            df2 = self.get_exceldf('test1.py', sheetname='Sheet1')  # bkwrd compat
    ...
    def test_sheet_name_both_raises(self):
        with tm.assert_raises_regex(TypeError, "Cannot specify both"):
            self.get_exceldf('test1.py', sheetname='Sheet1', sheet_name='Sheet1')
...
class XlrdTests(ReadingTestsBase):
    ...
    def test_excel_read_buffer(self):
        ...
        pth = os.path.join(self.dirpath, 'test1.py' + self.ext)
    ...
    def test_read_from_http_url(self):
        url = ('https://raw.github.com/pandas-dev/pandas/master/'
               'pandas/tests/io/data/test1.py' + self.ext)
        url_table = read_excel(url)
        local_table = self.get_exceldf('test1.py')
    ...
    def test_read_from_s3_url(self):
        ...
        with moto.mock_s3():
            ...
            file_name = os.path.join(self.dirpath, 'test1.py' + self.ext)
            with open(file_name, 'rb') as f:
                conn.Bucket("pandas-test").put_object(Key="test1.py" + self.ext,
                                                      Body=f)

            url = ('s3://pandas-test/test1.py' + self.ext)
            url_table = read_excel(url)
            local_table = self.get_exceldf('test1.py')
            tm.assert_frame_equal(url_table, local_table)
    ...
    def test_read_from_file_url(self):
        ...
        localtable = os.path.join(self.dirpath, 'test1.py' + self.ext)
    ...
    def test_read_from_pathlib_path(self):
        ...
        str_path = os.path.join(self.dirpath, 'test1.py' + self.ext)
        expected = read_excel(str_path, 'Sheet1', index_col=0)

        path_obj = Path(self.dirpath, 'test1.py' + self.ext)
    ...
    def test_read_from_py_localpath(self):
        ...
        path_obj = LocalPath(abs_dir).join('test1.py' + self.ext)
        actual = read_excel(path_obj, 'Sheet1', index_col=0)
    ...
    def test_read_excel_bool_header_arg(self):
        ...
        for arg in [True, False]:
            with pytest.raises(TypeError):
                pd.read_excel(os.path.join(self.dirpath, 'test1.py' + self.ext),
                              header=arg)
...
class ExcelWriterBase(SharedItems):
    ...
    def test_roundtrip(self):
        ...
        with ensure_clean(self.ext) as path:
            ...
            self.frame.to_excel(path, 'test1.py')
            self.frame.to_excel(path, 'test1.py', columns=['A', 'B'])
            self.frame.to_excel(path, 'test1.py', header=False)
            self.frame.to_excel(path, 'test1.py', index=False)

            # test roundtrip
            self.frame.to_excel(path, 'test1.py')
            recons = read_excel(path, 'test1.py', index_col=0)
            tm.assert_frame_equal(self.frame, recons)

            self.frame.to_excel(path, 'test1.py', index=False)
            recons = read_excel(path, 'test1.py', index_col=None)
            recons.index = self.frame.index
            tm.assert_frame_equal(self.frame, recons)

            self.frame.to_excel(path, 'test1.py', na_rep='NA')
            recons = read_excel(path, 'test1.py', index_col=0, na_values=['NA'])
            tm.assert_frame_equal(self.frame, recons)

            # GH 3611
            self.frame.to_excel(path, 'test1.py', na_rep='88')
            recons = read_excel(path, 'test1.py', index_col=0, na_values=['88'])
            tm.assert_frame_equal(self.frame, recons)
    ...
    def test_mixed(self):
        ...
        with ensure_clean(self.ext) as path:
            self.mixed_frame.to_excel(path, 'test1.py')
            reader = ExcelFile(path)
            recons = read_excel(reader, 'test1.py', index_col=0)
    ...
    def test_tsframe(self):
        ...
        with ensure_clean(self.ext) as path:
            df.to_excel(path, 'test1.py')
            reader = ExcelFile(path)
            recons = read_excel(reader, 'test1.py')
        ...
        for np_type in (np.int8, np.int16, np.int32, np.int64):
            ...
            with ensure_clean(self.ext) as path:
                ...
                frame = DataFrame(np.random.randint(-10, 10, size=(10, 2)),
                                  dtype=np_type)
                frame.to_excel(path, 'test1.py')
                reader = ExcelFile(path)
                recons = read_excel(reader, 'test1.py')
                int_frame = frame.astype(np.int64)
                tm.assert_frame_equal(int_frame, recons)
                recons2 = read_excel(path, 'test1.py')
                tm.assert_frame_equal(int_frame, recons2)

                # test with convert_float=False comes back as float
                float_frame = frame.astype(float)
                recons = read_excel(path, 'test1.py', convert_float=False)
    ...
    def test_float_types(self):
        ...
        for np_type in (np.float16, np.float32, np.float64):
            with ensure_clean(self.ext) as path:
                ...
                frame.to_excel(path, 'test1.py')
                reader = ExcelFile(path)
                recons = read_excel(reader, 'test1.py').astype(np_type)
    ...
    def test_sheets(self):
        ...
        with ensure_clean(self.ext) as path:
            ...
            self.frame.to_excel(writer, 'test1.py')
            ...
            assert 'test1.py' == reader.sheet_names[0]
    ...
    def test_colaliases(self):
        ...
        with ensure_clean(self.ext) as path:
            ...
            self.frame2.to_excel(path, 'test1.py', header=col_aliases)
            reader = ExcelFile(path)
            rs = read_excel(reader, 'test1.py', index_col=0)
            xp = self.frame2.copy()
    ...
    def test_roundtrip_indexlabels(self):
        ...
        with ensure_clean(self.ext) as path:
            ...
            reader = ExcelFile(path)
            recons = read_excel(reader, 'test1.py', index_col=[0, 1])
    ...
    def test_excel_roundtrip_datetime(self):
        ...
        with ensure_clean(self.ext) as path:
            ...
            tsf.to_excel(path, 'test1.py', merge_cells=self.merge_cells)
            reader = ExcelFile(path)
            recons = read_excel(reader, 'test1.py')
            tm.assert_frame_equal(self.tsframe, recons)
    ...
    def test_excel_date_datetime_format(self):
        ...
        with ensure_clean(self.ext) as filename1:
            with ensure_clean(self.ext) as filename2:
                ...
                df.to_excel(writer1, 'test1.py')
                df.to_excel(writer2, 'test1.py')
                ...
                rs1 = read_excel(reader1, 'test1.py', index_col=None)
                rs2 = read_excel(reader2, 'test1.py', index_col=None)
    ...
    def test_to_excel_multiindex(self):
        ...
        with ensure_clean(self.ext) as path:
            frame.to_excel(path, 'test1.py', header=False)
            frame.to_excel(path, 'test1.py', columns=['A', 'B'])

            # round trip
            frame.to_excel(path, 'test1.py', merge_cells=self.merge_cells)
            reader = ExcelFile(path)
            df = read_excel(reader, 'test1.py', index_col=[0, 1])
    ...
    def test_to_excel_multiindex_cols(self):
        ...
        with ensure_clean(self.ext) as path:
            ...
            frame.to_excel(path, 'test1.py', merge_cells=self.merge_cells)
            reader = ExcelFile(path)
            df = read_excel(reader, 'test1.py', header=header,
                            index_col=[0, 1])
            if not self.merge_cells:
    ...
    def test_to_excel_multiindex_dates(self):
        ...
        with ensure_clean(self.ext) as path:
            ...
            tsframe.to_excel(path, 'test1.py', merge_cells=self.merge_cells)
            reader = ExcelFile(path)
            recons = read_excel(reader, 'test1.py',
                                index_col=[0, 1])
    ...
    def test_to_excel_multiindex_no_write_index(self):
        ...
        with ensure_clean(self.ext) as path:
            ...
            frame2.to_excel(path, 'test1.py', index=False)

            # Read it back in.
            reader = ExcelFile(path)
            frame3 = read_excel(reader, 'test1.py')
    ...
    def test_to_excel_float_format(self):
        ...
        with ensure_clean(self.ext) as filename:
            df.to_excel(filename, 'test1.py', float_format='%.2f')

            reader = ExcelFile(filename)
            rs = read_excel(reader, 'test1.py', index_col=None)
    ...
    #     pdf.to_excel(filename, 'test1.py')

    #     wbk = xlrd.open_workbook(filename,
    #                              formatting_info=True)
    #     assert ["test1.py"] == wbk.sheet_names()
    #     ws = wbk.sheet_by_name('test1.py')
    ...
    #     assert ["test1.py"] == wbk.get_sheet_names()
    #     ws = wbk.get_sheet_by_name('test1.py')
    ...
    def test_duplicated_columns(self):
        ...
        with ensure_clean(self.ext) as path:
            ...
            write_frame.to_excel(path, 'test1.py')

            read_frame = read_excel(path, 'test1.py')
            ...
            # 10982
            write_frame.to_excel(path, 'test1.py', index=False, header=False)
            read_frame = read_excel(path, 'test1.py', header=None)
    ...
    def test_swapped_columns(self):
        ...
        with ensure_clean(self.ext) as path:
            write_frame = DataFrame({'A': [1, 1, 1],
                                     'B': [2, 2, 2]})
            write_frame.to_excel(path, 'test1.py', columns=['B', 'A'])

            read_frame = read_excel(path, 'test1.py', header=0)
    ...
    def test_invalid_columns(self):
        ...
        with ensure_clean(self.ext) as path:
            ...
            with tm.assert_produces_warning(FutureWarning,
                ...
                write_frame.to_excel(path, 'test1.py', columns=['B', 'C'])
            expected = write_frame.reindex(columns=['B', 'C'])
            read_frame = read_excel(path, 'test1.py')
            tm.assert_frame_equal(expected, read_frame)

            with pytest.raises(KeyError):
                write_frame.to_excel(path, 'test1.py', columns=['C', 'D'])
