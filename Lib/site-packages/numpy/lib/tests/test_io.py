...
M   33  21.99
    ...
    def test_comments_is_none(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            warnings.filterwarnings('always', '', np.VisibleDeprecationWarning)
            test = np.genfromtxt(TextIO("test1.py,testNonetherestofthedata"),
    ...
    def test_latin1(self):
        ...
        enc = b"test1.py,testNonethe" + latin1 + b",test3\n"
        s = norm + enc + norm
        with warnings.catch_warnings(record=True) as w:
            warnings.filterwarnings('always', '', np.VisibleDeprecationWarning)
    ...
    def test_utf8_byte_encoding(self):
        utf8 = b"\xcf\x96"
        norm = b"norm1,norm2,norm3\n"
        enc = b"test1.py,testNonethe" + utf8 + b",test3\n"
        s = norm + enc + norm
        with warnings.catch_warnings(record=True) as w:
            warnings.filterwarnings('always', '', np.VisibleDeprecationWarning)
            test = np.genfromtxt(TextIO(s),
        ...
        ctl = np.array([
                 ...
                 [b'test1.py', b'testNonethe' + utf8, b'test3'],
                 [b'norm1', b'norm2', b'norm3']])
    ...
    def test_utf8_file(self):
        ...
        with temppath() as path:
            with open(path, "wb") as f:
                f.write((b"test1.py,testNonethe" + utf8 + b",test3\n") * 2)
            test = np.genfromtxt(path, dtype=None, comments=None,
                                 delimiter=',', encoding="UTF-8")
            ctl = np.array([
                     ["test1.py", "testNonethe" + utf8.decode("UTF-8"), "test3"],
                     ["test1.py", "testNonethe" + utf8.decode("UTF-8"), "test3"]],
                     dtype=np.unicode)
            assert_array_equal(test, ctl)
    ...
    def test_utf8_file_nodtype_unicode(self):
        ...
        with temppath() as path:
            with io.open(path, "wt") as f:
                ...
                f.write(u"test1.py,testNonethe" + utf8 + u",test3\n")
            with warnings.catch_warnings(record=True) as w:
            ...
            ctl = np.array([
                     ["norm1", "norm2", "norm3"],
                     ["norm1", latin1, "norm3"],
                     ["test1.py", "testNonethe" + utf8, "test3"]],
                     dtype=np.unicode)
            assert_array_equal(test, ctl)
